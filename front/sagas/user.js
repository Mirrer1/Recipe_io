...
import { 
  ...
  LOAD_MY_ALERT_REQUEST, LOAD_MY_ALERT_SUCCESS, LOAD_MY_ALERT_FAILURE,
  CHECKED_ALERT_REQUEST, CHECKED_ALERT_SUCCESS, CHECKED_ALERT_FAILURE,
  LOAD_USER_INFO_REQUEST, LOAD_USER_INFO_SUCCESS, LOAD_USER_INFO_FAILURE,
  LOAD_LIKED_POSTS_REQUEST, LOAD_LIKED_POSTS_SUCCESS, LOAD_LIKED_POSTS_FAILURE,
  LOAD_BOARD_POSTS_REQUEST, LOAD_BOARD_POSTS_SUCCESS, LOAD_BOARD_POSTS_FAILURE,
  LOG_IN_REQUEST, LOG_IN_SUCCESS, LOG_IN_FAILURE, 
  LOG_OUT_REQUEST, LOG_OUT_SUCCESS, LOG_OUT_FAILURE, 
  SEND_AUTH_MAIL_REQUEST, SEND_AUTH_MAIL_SUCCESS, SEND_AUTH_MAIL_FAILURE,
