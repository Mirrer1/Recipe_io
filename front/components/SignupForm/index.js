...
import { SignUpForm, SignUpReturnBtn, AuthResendBtn, AuthOkBtn, AuthEmailBtn } from '../../styles/signUpForm';
    ...
    <section>      
      ...
      >
          ...
          <Row gutter={16} align='end'>
            { 
              ...
              <Col span={8}>
                ...
                : <Input placeholder='인증번호 6자리' allowClear onChange={onChangeAuthCode}/>            
                }                
              </Col>            
            }
        ...
        <Form.Item
          ...
          hasFeedback
        >
          <InputWrapper placeholder='비밀번호 (8 ~ 20자리)' minLength={8} maxLength={20} showCount allowClear/>
        </Form.Item>
        ...
        >
          <Input placeholder='닉네임을 입력해주세요.' maxLength={20} showCount allowClear/>
        </Form.Item>    
        ...
        <Row align='center'>
          <Form.Item>
            <SignUpReturnBtn onClick={signUpCancelBtn}>돌아가기</SignUpReturnBtn>
