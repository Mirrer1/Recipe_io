      ...
      >
        ...
        <Row justify='end'>
          {liked ? (
            ...
            >
              <TopPostBtnText>{post.Likers.length}</TopPostBtnText>
            </TopPostBtn>
          ) : (
            <TopPostBtn type='text' icon={<HeartOutlined />}>
              <TopPostBtnText>{post.Likers.length}</TopPostBtnText>
            </TopPostBtn>
          )}
          <TopPostBtn type='text' icon={<CommentOutlined />}>
            <TopPostBtnText>{post.Comments.length}</TopPostBtnText>
          </TopPostBtn>
        </Row>
      </Card>
    </article>
