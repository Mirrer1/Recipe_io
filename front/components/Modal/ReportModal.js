  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Select
            onSelect={onClickOtherReason}
            placeholder='신고사유를 선택해주세요.'
          >
            <Select.Option value='영리 / 홍보 목적'>
              영리 / 홍보 목적
            </Select.Option>
            <Select.Option value='욕설 / 반말 / 부적절한 언어 사용'>
              욕설 / 반말 / 부적절한 언어 사용
            </Select.Option>
            <Select.Option value='도배성'>도배성</Select.Option>
            <Select.Option value='개인정보 노출'>개인정보 노출</Select.Option>
            <Select.Option value='음란성 / 선정성 위배'>
              음란성 / 선정성 위배
            </Select.Option>
        ...
        {otherReason && (
          ...
          >
            <Input
              placeholder='기존 선택사항 이외에 다른 신고사유를 입력해주세요.'
              allowClear
            />
          </Form.Item>
        )}
