...
import { likePostRequestAction, unLikePostRequestAction, moveToCommentRequestAction } from '../../reducers/post';
import { UserAvatarLink } from '../../styles/headerMenu';
import {
  TitleWrapper, TitleDate, HeaderTitle, HeaderWrapper, HeaderNicknameWrapper, HeaderNickname, 
  HeaderInfo, HeaderBtn, TwoToneHeartBtnIcon, HeartBtnIcon, CommentBtnIcon, HeaderDivider, 
} from '../../styles/modal';
    ...
    <>
      ...
      <HeaderWrapper>        
        ...
        <div>
          ...
          <HeaderBtn type='text' icon={<CommentBtnIcon />} onClick={modalHeaderCommentBtn} >{post.Comments.length}</HeaderBtn>                        
        </div>
      </HeaderWrapper>      
      <HeaderDivider />     
    </>
